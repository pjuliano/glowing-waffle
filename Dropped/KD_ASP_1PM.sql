Create or Replace View KD_ASP_1PM As
Select
    A.Region_Code,
    A.Salesman_Code,
...
Where
    A.InvoiceMthYr = Case When Extract(Month From Sysdate) = 1 Then '12' || '/' ||  To_Char(Extract(Year From Sysdate)-1)
                          When Extract(Month From Sysdate) = 2 Then '01'  || '/' ||  To_Char(Extract(Year From Sysdate))
                          When Extract(Month From Sysdate) = 3 Then '02'  || '/' ||  To_Char(Extract(Year From Sysdate))
                          When Extract(Month From Sysdate) = 4 Then '03'  || '/' ||  To_Char(Extract(Year From Sysdate))
                          When Extract(Month From Sysdate) = 5 Then '04'  || '/' ||  To_Char(Extract(Year From Sysdate))
                          When Extract(Month From Sysdate) = 6 Then '05'  || '/' ||  To_Char(Extract(Year From Sysdate))
                          When Extract(Month From Sysdate) = 7 Then '06'  || '/' ||  To_Char(Extract(Year From Sysdate))
                          When Extract(Month From Sysdate) = 8 Then '07'  || '/' ||  To_Char(Extract(Year From Sysdate))
                          When Extract(Month From Sysdate) = 9 Then '08'  || '/' ||  To_Char(Extract(Year From Sysdate))
                          When Extract(Month From Sysdate) = 10 then '09'  || '/' ||  To_Char(Extract(Year From Sysdate))
                          When extract(Month From Sysdate) = 11 Then '10'  || '/' ||  To_Char(Extract(Year From Sysdate))
                          When extract(Month From Sysdate) = 12 then '11'   || '/' ||  To_Char(Extract(Year From Sysdate)) End And

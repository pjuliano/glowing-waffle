Create or Replace View KD_WWSS_GlobalDist As
With Quota_Dist As (
  Select
    A.F1,
    Sum(A.Jan) As "1",
...
Select
  ...
  Round((Sum(Case When Extract(Month From A.Invoicedate) = Extract(Month From Sysdate) And
                  ...
                  Then A.Allamounts
                  Else 0
             End) / Decode(Extract(Month From Sysdate),1,B."1",2,B."2",3,B."3",4,B."4",5,B."5",6,B."6",7,B."7",8,B."8",9,B."9",10,B."10",11,B."11",12,B."12")) * 100,2) As Month_Pct_Plan,
  ...
  Round((Sum(Case When Decode(Extract(Month From Sysdate),1,'QTR1',2,'QTR1',3,'QTR1',4,'QTR2',5,'QTR2',6,'QTR2',7,'QTR3',8,'QTR3',9,'QTR3',10,'QTR4',11,'QTR4',12,'QTR4') = 
                  ...
                  Then A.Allamounts
                  Else 0
             End) / Decode(Extract(Month From Sysdate),1,B.Q1,2,B.Q1,3,B.Q1,4,B.Q2,5,B.Q2,6,B.Q2,7,B.Q3,8,B.Q3,9,B.Q3,10,B.Q4,11,B.Q4,12,B.Q4)) * 100,2) As Qtr_Pct_Plan,
  ...
  Round((Decode(Extract(Month From Sysdate),1,B.Q1,2,B.Q1,3,B.Q1,4,B.Q2,5,B.Q2,6,B.Q2,7,B.Q3,8,B.Q3,9,B.Q3,10,B.Q4,11,B.Q4,12,B.Q4) -
         Sum(Case When Decode(Extract(Month From Sysdate),1,'QTR1',2,'QTR1',3,'QTR1',4,'QTR2',5,'QTR2',6,'QTR2',7,'QTR3',8,'QTR3',9,'QTR3',10,'QTR4',11,'QTR4',12,'QTR4') = 
                ...
                Then A.Allamounts
                Else 0
              End)) / (D.Total_Sales_Days - D.Elapsed_Work_Days),2) As Qtr_Daily_Required,
  Round(((Sum(Case When Decode(Extract(Month From Sysdate),1,'QTR1',2,'QTR1',3,'QTR1',4,'QTR2',5,'QTR2',6,'QTR2',7,'QTR3',8,'QTR3',9,'QTR3',10,'QTR4',11,'QTR4',12,'QTR4') = 
                        Decode(Extract(Month From A.Invoicedate),1,'QTR1',2,'QTR1',3,'QTR1',4,'QTR2',5,'QTR2',6,'QTR2',7,'QTR3',8,'QTR3',9,'QTR3',10,'QTR4',11,'QTR4',12,'QTR4') And
                        Extract(Year From A.Invoicedate) = Extract(Year From Sysdate)
                   Then A.Allamounts
                   Else 0
              End) / D.Elapsed_Work_Days) * D.Total_Sales_Days) / Decode(Extract(Month From Sysdate),1,B.Q1,2,B.Q1,3,B.Q1,4,B.Q2,5,B.Q2,6,B.Q2,7,B.Q3,8,B.Q3,9,B.Q3,10,B.Q4,11,B.Q4,12,B.Q4) * 100,2) As Qtr_Run_Rate_Pct,
  Round(((Sum(Case When Decode(Extract(Month From Sysdate),1,'QTR1',2,'QTR1',3,'QTR1',4,'QTR2',5,'QTR2',6,'QTR2',7,'QTR3',8,'QTR3',9,'QTR3',10,'QTR4',11,'QTR4',12,'QTR4') = 
                        Decode(Extract(Month From A.Invoicedate),1,'QTR1',2,'QTR1',3,'QTR1',4,'QTR2',5,'QTR2',6,'QTR2',7,'QTR3',8,'QTR3',9,'QTR3',10,'QTR4',11,'QTR4',12,'QTR4') And
                        Extract(Year From A.Invoicedate) = Extract(Year From Sysdate)
                   Then A.Allamounts
                   Else 0
              End) / D.Elapsed_Work_Days) * D.Total_Sales_Days),2) As Qtr_Run_Rate_Sales,
  ...
  Round((Sum(Case When Extract(Year From A.Invoicedate) = Extract(Year From Sysdate)
                  Then A.Allamounts
                  Else 0
             End) / B.Total) * 100,2) As Year_Pct_Plan,
  ...
  Round((Sum(Case When Decode(Extract(Month From Sysdate),1,'QTR1',2,'QTR1',3,'QTR1',4,'QTR2',5,'QTR2',6,'QTR2',7,'QTR3',8,'QTR3',9,'QTR3',10,'QTR4',11,'QTR4',12,'QTR4') = 
           ...
           Sum(Case When Decode(Extract(Month From Sysdate),1,'QTR1',2,'QTR1',3,'QTR1',4,'QTR2',5,'QTR2',6,'QTR2',7,'QTR3',8,'QTR3',9,'QTR3',10,'QTR4',11,'QTR4',12,'QTR4') = 
                    ...
                    Then A.Allamounts
                    Else 0
               End)) * 100,2) As Prior_Year_Qtd_Pct,

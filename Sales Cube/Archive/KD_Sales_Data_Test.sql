...
Fixedamounts,
    ...
    FROM
        ...
        LEFT JOIN Kd_Currency_Rate_4 I ON TO_CHAR(A.Salesdate,'MM/YYYY') = I.Valid_From AND
        I.Currency_Code = 'EUR'
        ...
        LEFT JOIN Inventory_Part_Unit_Cost_Sum D ON A.Salespartno = D.Part_No AND
                                                    D.Contract = '210'
    WHERE
        A.Salesdate >= TO_DATE('01/01/2008','MM/DD/YYYY')
    UNION ALL
    SELECT
        '3' As QRY,
        '240' AS Site,
...
,
    ...
    FROM
        Srordersitl A
        LEFT JOIN Cust_Ord_Customer_Tab B ON A.Customerid = B.Customer_No
        LEFT JOIN Kd_Currency_Rate_4 I ON TO_CHAR(A.Salesdate,'MM/YYYY') = I.Valid_From and I.Currency_Code = 'EUR'
        LEFT JOIN Inventory_Part_Unit_Cost_Sum C ON A.Salespartno = C.Part_No AND
                                                    C.Contract = '100'
        LEFT JOIN Inventory_Part_Unit_Cost_Sum D ON A.Salespartno = D.Part_No AND
                                                    D.Contract = '210'
    ...
    FROM
        ...
        LEFT JOIN Kd_Currency_Rate_4 I ON TO_CHAR(A.Salesdate,'MM/YYYY') = I.Valid_From AND
        I.Currency_Code = 'SEK'
        LEFT JOIN Kd_Currency_Rate_4 J ON TO_CHAR(A.Salesdate,'MM/YYYY') = J.Valid_From AND
        J.Currency_Code = 'EUR'
        LEFT JOIN Inventory_Part_Unit_Cost_Sum C ON A.Salespartno = C.Part_No AND
                                                    C.Contract = '100'
        LEFT JOIN Inventory_Part_Unit_Cost_Sum D ON A.Salespartno = D.Part_No AND
...
UNION ALL
    ...
    Select '17', A.* From KD_PT_Sales_Data A;
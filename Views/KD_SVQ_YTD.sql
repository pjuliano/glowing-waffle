...
Select
  ...
  A.This_Year - Round(Sum(B.Daily_Quota),2) As YTD_Quota_Remaining,
  ...
  A.This_Year - A.Year_Quota As Year_Remaining,
  A.This_Year_Implants - A.Year_Quota_Impl as Year_Remaining_Impl,
  A.This_Year_Bio - A.Year_Quota_Bio As Year_Remaining_Bio
From
  Kd_Svq_This_Year A,
...
Group By
  ...
  A.This_Year - A.Year_Quota,
  A.This_Year_Implants - A.Year_Quota_Impl,
  A.This_Year_Bio - A.Year_Quota_Bio;
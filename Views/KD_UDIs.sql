...
Select
  ...
  Mod(
      ...
      Nvl((Select Value From Kd_Udi_Chars Where Character = Substr(Decode(Expiration_Date,Null,'','$$3'),1,1)),0) + --Date/Lot reference identifier (0 if Expiration Date is Null, indicating a non-sterile part)
      Nvl((Select Value From Kd_Udi_Chars Where Character = Substr(Decode(Expiration_Date,Null,'','$$3'),2,1)),0) +
      Nvl((Select Value From Kd_Udi_Chars Where Character = Substr(Decode(Expiration_Date,Null,'','$$3'),3,1)),0) +

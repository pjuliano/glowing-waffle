Create Or Replace View KD_ASP_3PQ As 
Select
    A.Region_Code,
    A.Salesman_Code,
...
Where
    A.InvoiceQtrYr = 'QTR' || Case When To_Char(Sysdate,'Q') = 1 Then '2' || '/' || To_Char(Extract(Year From Sysdate)-1) 
                                   When To_Char(Sysdate,'Q') = 2 Then '3' || '/' || To_Char(Extract(Year From Sysdate)-1) 
                                   When To_Char(Sysdate,'Q') = 3 Then '4' || '/' || To_Char(Extract(Year From Sysdate)-1)
                                   When To_Char(Sysdate,'Q') = 4 Then '1' || '/' || To_Char(Extract(Year From Sysdate)) End And

...
Select
  ...
  --L.PY_This_Month_SD As PYMTD_SD, --Rem
  C.This_Month_Implants,
  C.This_Month_Bio,
  --C.This_Month_Gross_Margin, --Rem
  C.Month_Quota_Pct,
  ...
  B.This_Quarter,
  --K.Py_This_Quarter_Sd As PYQTD_SD, --Rem
  ...
  A.This_Year_Bio,
  --J.PY_Year_SD As PYYTD_SD, --Rem
  --A.This_Year_Second_Half, --Rem
  A.Year_Quota_Pct,

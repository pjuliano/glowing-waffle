--------------------------------------------------------
--  DDL for View KD_MRP_MOH_SALES
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "IFSAPP"."KD_MRP_MOH_SALES" ("RM_PART_NO", "ON_HAND_RM", "OPEN_PO_RM", "RM_RATIO", "RMFG_SPLIT_TOTAL", "PROC_PART_NO", "ON_HAND_PROC", "OPEN_PO_PROC", "OPEN_SO_PROC", "PROC_TOTAL", "FG_PART_NO", "FG_PART_INDEX", "ON_HAND_FG", "OPEN_SO_FG", "FG_TOTAL", "TOTAL_INVENTORY", "ACTIVE_MONTHS", "UNITS_SOLD_12M", "AVG_MONTHLY_SALES", "MONTHS_ON_HAND") AS 
  Select
    A.Rm_Part_No,
    B.On_Hand_RM,
    B.Open_PO_RM,
